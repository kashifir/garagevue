...
<tfoot> : groupe de cellules de pied de tableau -->
      ...
      <tbody v-if="clients">
        <tr
          ...
          :key="client.id"
          v-bind:class="{ trcolor: client.id % 2 === 0 }"
        >
          <td>{{ client.id }}</td>
          <td>{{ client.nom }}</td>
          <td>{{ client.prenom }}</td>
    ...
    <div class="newclient" v-if="!show">
      <form>
        <fieldset v-show="next">
          ...
          <div class="btn-next">
            <button @click="next = false" class="glow-on-hover" type="button">
              Next
            </button>
          </div>
        </fieldset>
        <fieldset v-show="!next">
          ...
          <div class="btn-prev">
            <button @click="next = true" class="glow-on-hover" type="button">
              prev
            </button>
          </div>
          <div class="btn-submit">
            <button @click="addclient" class="glow-on-hover" type="button">
              Submit
            </button>
          </div>
        </fieldset>
...
export default {
  ...
  methods: {
    addclient: function() {
      this.axios
        .post("http://localhost:3000/client/new", {
          nom: this.nom,
          prenom: this.prenom,
          email: this.email,
          tel: this.tel,
          ...
          numero_plaque: this.numero_plaque,
          couleur: this.couleur,
          nb_place: this.nb_place,
          annee: this.annee,
          nb_port: this.nb_place,
