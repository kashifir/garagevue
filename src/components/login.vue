    ...
    <div class="newlogin">
      <form>
        <fieldset>
          ...
          <div class="btn-next">
            <button @click="dologin" class="glow-on-hover" type="button">
              Submit
            </button>
          </div>
        </fieldset>
...
export default {
  ...
  methods: {
    dologin: function() {
      this.axios
        .post("http://localhost:3000/employe/login", {
          email: this.email,
...
.newlogin input[type="tel"],
.newlogin input[type="number"],
