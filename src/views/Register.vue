    ...
    <div class="newregister">
      <form>
        <fieldset>
          ...
          <div class="btn-next">
            <button @click="doregister" class="glow-on-hover" type="button">
              Register
            </button>
          </div>
        </fieldset>
...
export default {
  ...
  methods: {
    doregister: function() {
      this.axios
        .post("http://localhost:3000/employe/register", {
          nom: this.nom,
          prenom: this.prenom,
          email: this.email,
          tel: this.tel,
...
.newregister textarea {
  width: 250px;
  height: 100px;
}
.newregister input[type="text"],
.newregister input[type="email"],
.newregister input[type="tel"],
.newregister input[type="password"] {
  border-radius: 25px;
  border: 1px solid #ccc;
  outline: none;
  color: black;
